...
const [selectedImage, setSelectedImage] = useState(null);
  ...
  return (
            ...
            from-[#1a120b] via-[#3e2b1d] to-[#3e2b1d]'>
                          ...
                          {cartItems.map(({ _id, item, quantity }) => (
                            ...
                            <div key={_id}
                                ...
                                <div className='w-full text-center'>
                                    ...
                                    <p className='text-amber-100/80 font-cinzel mt-1'>VND{Number(item.price).toFixed(2)}</p>
                                    </div>
                                ...
                                <div className='flex items-center gap-3'>
                                    <button onClick={() => updateQuantity(_id, Math.max(1,quantity - 1))}
                                        ...
                                        <FaMinus className='w-8 text-center text-amber-100' />
                                    </button>
                                    ...
                                    <button onClick={() => updateQuantity(_id,quantity + 1)}
                                        className='w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50
                                        transition-all duration-200 active:scale-95'>
                                        <FaPlus className='w-8 text-center text-amber-100' />
                                    </button>
