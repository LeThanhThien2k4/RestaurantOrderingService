...
const Contact = () => {
            ...
            const subject = encodeURIComponent("Yêu cầu từ khách hàng");
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        ...
                        <div className='space-y-6'>
                            ...
                            group-hover:opacity-100 transition-opacity duration-300 rounded-2xl'/>
                                ...
                                <h3 className=' ml-4 text-amber-100 text-xl font-semibold'>Trụ sở của chúng tôi</h3>
                            ...
                            group-hover:opacity-100 transition-opacity duration-300 rounded-2xl'/>
                                ...
                                <h3 className=' ml-4 text-amber-100 text-xl font-semibold'>liên lạc số điện thoại</h3>
                            ...
                            group-hover:opacity-100 transition-opacity duration-300 rounded-2xl'/>
                                ...
                                <h3 className=' ml-4 text-orange-100 text-xl font-semibold'>Địa chỉ Email</h3>

                            </div>

                                <div className='pl-12 relative z-10'>
                                <p className='text-orange-100 font-light text-lg'>
                                2200007423@nttu.edu.vn
                                </p>
                                </div>
                            </div>
                            ...
                            {contactFormFields.map(({ label, name, type, placeholder, pattern, Icon }) => (
                                ...
                                <div>
                                    ...
                                    <div className='relative'>
                                        ...
                                        text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent
                                        placeholder-amber-200/50'
                                        placeholder='Hãy nhắn ở đây...' required>
                                        </textarea>
                                    </div>
                                    </div>
