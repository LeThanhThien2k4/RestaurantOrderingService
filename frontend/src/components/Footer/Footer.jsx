...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(t("footer.subscription.alert", { email }));
    setEmail('');
  };
          ...
          <div className=' space-y-6'>
            ...
            <form onSubmit={handleSubmit} className=' relative mt-4 group'>
              <div className=' flex items-center gap-2 mb-2'>
                ...
                <span className='font-bold text-amber-400'>{t("footer.subscription.title")}</span>
              </div>
                ...
                {navItems.map(item => (
                  <li key={item.name}>
                    <a href={item.link} className=' flex items-center hover:text-amber-400 transition-all group font-lora hover:pl-2'>
                      ...
                      <span className=' hover:italic'>{t(`footer.navigation.${item.name}`)}</span>
                    </a>
                  </li>
                ))}
              </ul>
