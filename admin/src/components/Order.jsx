...
import { FiBox, FiUser, FiClock, FiTruck, FiCheckCircle, FiTrash2 } from 'react-icons/fi';
                      ...
                      <td className={`${tableClasses.cellBase} text-center`}>
                        <div className='space-y-1 max-h-52 overflow-auto'>
                          {order.items.map((itm, idx) => (
                            <div key={idx} className='flex items-center gap-3 p-2 rounded-lg justify-center'>
                              <img
                                src={
                              ...
                              <div className='flex-1'>
                                ...
                                <div className='flex items-center gap-2 text-xs text-amber-400/60'>
                                  <span>VND{itm.item.price.toFixed(2)}</span>
                                  <span>&middot;</span>
